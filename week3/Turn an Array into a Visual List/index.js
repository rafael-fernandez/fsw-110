...
// we want to select these array items, create an UL, and place these array items as children list items

var rangersList = document.getElementById("rangers")

for (var i = 0; i < powerRangers.length; i++) {

    var myFriends = document.createElement("friends");
    myFriends.textContent = powerRangers[i];
